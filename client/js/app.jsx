      ...
      <div>
        <Form inline onSubmit={this.handleSubmit}>
          <FormItem
            id="code"
            label="股票代码：">
            <Input placeholder="请输入账户名" id="code" name="code" onChange={this.handleChange.bind(this, 'code')} value={this.state.code} />
          </FormItem>
          <FormItem
            id="author"
            label="推荐人：">
...
var HomePage = React.createClass({
  loadCommentsFromServer: function() {
    var that = this;
    request(this.props.url, function (err, response, r) {
      var j = JSON.parse(r);
      that.setState({data: j.result});
    });
  },
